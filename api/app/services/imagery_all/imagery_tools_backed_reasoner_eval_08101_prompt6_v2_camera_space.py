...
- You must resolve the problem by attempting to rotate the target objects (A, B, C) until they visually overlap with the original Reference image. Do not rely on mental 3D reconstruction or abstract shape inference. 
- Multiple iterations may be required to find the match. Run as much iterations as needed.
...
class ToolsBackedImageryReasoner_Eval_08101_Prompt6_v2:
