...
- **Example:** `yaw:90, yaw:90, pitch:45, yaw:45` (Target: "A")
...
```json
{
  ...
  "commands": [
    {
      "target": "B", 
      "rotation_sequence": "yaw:90,pitch:-20,yaw:90"
    }
  ],
  "final_answer": null 
}
...
- **Commands:** `yaw` (orbit), `pitch` (vertical), `roll` (spin view).
...
class ToolsBackedImageryReasoner_Eval_08102:
        ...
        try:
            ...
            while iter_count <= MAX_ITERATION:
                ...
                for target, commands in commands_map.items():
                    ...
                    image_path = imagery.run_sequence_and_save_image(target, commands)
