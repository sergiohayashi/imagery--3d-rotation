...
Each command in the sequence will generate a snapshot image relative to the angle after the command is applied.
...
class ToolsBackedImageryReasoner_Eval_08101_Prompt2:
