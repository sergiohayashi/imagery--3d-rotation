...
You are provided an initial 3D model generation code, that will be the 'foundation mode', followed by the 2D image, generated from that.
...
class ToolsBackedImageryReasoner:
