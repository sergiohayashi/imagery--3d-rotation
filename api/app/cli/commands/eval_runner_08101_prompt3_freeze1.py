...
def register(subparsers):
    parser = subparsers.add_parser("eval08101_p3_f1")
    parser.add_argument("--start", required=False)
    parser.add_argument("--end", required=False)
    parser.add_argument("--list", required=False)
    parser.add_argument("--reasoning-model", required=False)
    parser.set_defaults(handler=EvalRunner08101Prompt3Freeze1)


class EvalRunner08101Prompt3Freeze1(CommandBase):
    ...
    async def run_eval(
        ...
        chat_message: ChatMessage = ChatMessage(
            ...
            use_model=[
                ModelWithParameters(
                    name="tools-based-imagery--eval-08101_prompt3_freeze1"
                )
            ],
            preset_list=[
                {
