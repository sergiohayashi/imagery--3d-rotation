...
def register(subparsers):
    parser = subparsers.add_parser("eval09101_p3_f1")
    parser.add_argument("--start", required=False)
    parser.add_argument("--end", required=False)
    parser.add_argument("--list", required=False)
    parser.add_argument("--reasoning-model", required=False)
    parser.set_defaults(handler=EvalRunner09101Prompt3Freeze1)


class EvalRunner09101Prompt3Freeze1(CommandBase):
    ...
    async def run_eval(
        ...
        chat_message: ChatMessage = ChatMessage(
            ...
            use_model=[
                ModelWithParameters(
                    name="tools-based-imagery--eval-09101_prompt3_freeze1"
                )
            ],
            preset_list=[
                {
