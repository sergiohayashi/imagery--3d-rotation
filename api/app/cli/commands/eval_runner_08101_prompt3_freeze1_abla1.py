...
def register(subparsers):
    parser = subparsers.add_parser("eval08101_p3_f1_a1")
    parser.add_argument("--start", required=False)
    parser.add_argument("--end", required=False)
    parser.add_argument("--list", required=False)
    parser.set_defaults(handler=EvalRunner08101Prompt3Freeze1Ablation360view)


class EvalRunner08101Prompt3Freeze1Ablation360view(CommandBase):
    ...
    async def run_eval(
        ...
        chat_message: ChatMessage = ChatMessage(
            ...
            use_model=[
                ModelWithParameters(
                    name="tools-based-imagery--eval-08101_prompt3_freeze1_ablation1"
                )
            ],
            preset_list=[
                {
